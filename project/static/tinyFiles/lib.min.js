...
//# sourceMappingURL=nv.d3.min.js.map/*1446572042,,JIT Construction: v2021733,en_US*/
...
__d('ES6Number',[],function a(b,c,d,e,f,g){if(c.__markCompiled)c.__markCompiled();var h=Math.pow(2,53)-1,i=-1*h,j={isFinite:function(k){return typeof k=='number'&&isFinite(k);},isNaN:function(k){return typeof k=='number'&&isNaN(k);},isInteger:function(k){return this.isFinite(k)&&Math.floor(k)===k;},isSafeInteger:function(k){return this.isFinite(k)&&k>=this.MIN_SAFE_INTEGER&&k<=this.MAX_SAFE_INTEGER&&Math.floor(k)===k;},MAX_SAFE_INTEGER:h,MIN_SAFE_INTEGER:i};f.exports=j;},null);
